...
function MetaAuditPanel() {
  ...
  const knownPages: MetaPageInfo[] = [
    ...
    { url: "https://hitcf.com/zh/login", title: "\u767b\u5f55 | HiTCF", titleLen: 9, description: "\u767b\u5f55 HiTCF \u8d26\u53f7\u5f00\u59cb\u7ec3\u4e60 TCF Canada\u3002\u8fd8\u6ca1\u6709\u8d26\u53f7\uff1f\u514d\u8d39\u6ce8\u518c\uff0c\u7acb\u5373\u5f00\u59cb\u5907\u8003 CLB 7+\u3002", descLen: 44, titleStatus: "warning", descStatus: "warning" },
  ];
